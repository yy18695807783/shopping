...
public class MyConstants {
    ...
    //服务器ip地址
//    public static final String BASE = "http://192.168.31.209:8080";
    public static final String BASE = "http://192.168.1.5:8080";
//    public static final String BASE = "http://10.0.2.2:8080";//tomecat默认地址

    // 请求Json数据基本URL   http://192.168.1.144:8080/atguigu/json/
    public static final String BASE_URL_JSON = BASE+"/atguigu/json/";

    // 请求图片基本URLhttp://192.168.1.144:8080/atguigu/img
    ...
    public static int RESAULT_LOGIN = 0;//普通登陆按钮
}
